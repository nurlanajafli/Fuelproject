...
class AccountController extends BaseController
{
	...
	public function actionCreate() {
		...
		try {
			if ($model->load($_POST) && $model->save()) {
				return $this->redirect(['view', 'account' => $model->account]);
	 ...
	 */
	protected function findModel($account) {
		if (($model = Account::findOne($account)) !== null) {
			return $model;
		} else {
