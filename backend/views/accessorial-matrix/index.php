 ...
 */
$this->title = Yii::t('app', 'Accessorial Matrices');
...
?>
<div class="giiant-crud accessorial-matrix-index">
...
//         ?>
    ...
    <h1>
        <?php echo Yii::t('app', 'Accessorial Matrices') ?>
        <small>
            List
        </small>
    </h1>
...
\yii\bootstrap\ButtonDropdown::widget(
	[
		...
		'dropdown' => [
			...
			'items' => [
				[
					'url' => ['accessorial-rating/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('app', 'Accessorial Rating'),
				],
