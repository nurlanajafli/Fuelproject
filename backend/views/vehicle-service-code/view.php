...
?>
<div class="giiant-crud vehicle-service-code-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'code' => $model->code, 'VehicleServiceCode'=>$copyParams],
    ...
    <?php $this->beginBlock('common\models\VehicleServiceCode'); ?>
    ...
    <?= Html::a('<span class="glyphicon glyphicon-trash"></span> ' . 'Delete', ['delete', 'code' => $model->code],
    [
 ...
 [
    ...
    'content' => $this->blocks['common\models\VehicleServiceCode'],
    'active'  => true,
],
 ]
                 ]
