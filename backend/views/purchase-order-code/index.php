 ...
 */
$this->title = Yii::t('app', 'Purchase Order Codes');
...
?>
<div class="giiant-crud purchase-order-code-index">
...
//         ?>
    ...
    <h1>
        <?php echo Yii::t('app', 'Purchase Order Codes') ?>
        <small>
            List
        </small>
    </h1>
		...
		'columns' => [
			...
			[
				...
				'value' => function ($model) {
					if ($rel = $model->account) {
						return Html::a($rel->account, ['account/view', 'account' => $rel->account, ], ['data-pjax' => 0]);
					} else {
						return '';
					}
				},
