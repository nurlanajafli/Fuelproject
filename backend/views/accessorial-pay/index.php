 ...
 */
$this->title = Yii::t('app', 'Accessorial Pays');
...
?>
<div class="giiant-crud accessorial-pay-index">
...
//         ?>
    ...
    <h1>
        <?php echo Yii::t('app', 'Accessorial Pays') ?>
        <small>
            List
        </small>
    </h1>
		...
		'dropdown' => [
			...
			'items' => [
				[
					...
					'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('app', 'Accessorial Rating'),
				],
				[
					'url' => ['office/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('app', 'Office'),
				],
    ...
    <div class="table-responsive">
		...
		'columns' => [
			...
			[
				...
				'value' => function ($model) {
					if ($rel = $model->accessorialRating) {
						return Html::a($rel->_label, ['accessorial-rating/view', 'id' => $rel->id, ], ['data-pjax' => 0]);
					} else {
                        return '';
					}
				},
