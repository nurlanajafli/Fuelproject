...
?>
<div class="giiant-crud log-activity-code-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'code' => $model->code, 'LogActivityCode'=>$copyParams],
    ...
    <?php $this->beginBlock('common\models\LogActivityCode'); ?>
 ...
 [
    ...
    'content' => $this->blocks['common\models\LogActivityCode'],
    'active'  => true,
],
 ]
                 ]
