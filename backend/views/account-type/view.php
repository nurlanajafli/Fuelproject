...
?>
<div class="giiant-crud account-type-view">
	...
	['create', 'id' => $model->id, 'AccountType'=>$copyParams],
    ...
    <?php $this->beginBlock('common\models\AccountType'); ?>
	...
	[
		...
		'items' => [
			[
				...
				'content' => $this->blocks['common\models\AccountType'],
				'active'  => true,
			],
		]
	]
