...
?>
<div class="giiant-crud accident-code-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            <?= Html::a(
                ...
                ['create', 'code' => $model->code, 'AccidentCode' => $copyParams],
    ...
    <?php $this->beginBlock('common\models\AccidentCode'); ?>
        ...
        [
            ...
            'items' => [
                [
                    ...
                    'content' => $this->blocks['common\models\AccidentCode'],
                    'active' => true,
                ],
            ]
        ]
