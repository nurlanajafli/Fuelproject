...
?>
<div class="giiant-crud commodity-view">
	...
	['create', 'id' => $model->id, 'Commodity'=>$copyParams],
    ...
    <?php $this->beginBlock('common\models\Commodity'); ?>
    ...
    <?php echo DetailView::widget([
		...
		'attributes' => [
			...
			[
				...
				'value' => ($model->hazmatCode ?
					Html::a('<i class="glyphicon glyphicon-list"></i>', ['hazmat/index']).' '.
					Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->hazmatCode->code, ['hazmat/view', 'code' => $model->hazmatCode->code, ]).' '.
					Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'Commodity'=>['hazmat_code' => $model->hazmat_code]])
					:
	...
	[
		...
		'items' => [
			[
				...
				'content' => $this->blocks['common\models\Commodity'],
				'active'  => true,
			],
		]
	]
