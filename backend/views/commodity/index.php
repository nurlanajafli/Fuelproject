 ...
 */
$this->title = Yii::t('models', 'Commodities');
...
?>
<div class="giiant-crud commodity-index">
...
//         ?>
    ...
    <h1>
        <?php echo Yii::t('models', 'Commodities') ?>
        <small>
            List
        </small>
    </h1>
	...
	[
		...
		'dropdown' => [
			...
			'items' => [
				[
					'url' => ['hazmat/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('models', 'Hazmat'),
				],
			...
			[
				...
				'value' => function ($model) {
					if ($rel = $model->hazmatCode) {
						return Html::a($rel->code, ['hazmat/view', 'code' => $rel->code, ], ['data-pjax' => 0]);
					} else {
						return '';
					}
				},
