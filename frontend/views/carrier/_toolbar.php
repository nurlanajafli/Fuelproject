...
<div class="card-header py-3">
    <div class="edit-form-toolbar">
        ...
        <button class="btn btn-link<?php if (!$model->id) : ?> disabled<?php else: ?> js-ajax-modal<?php endif ?>" data-url="<?php echo Url::toRoute(['document/index', 'type' => 'carrier', 'id' => $model->id]) ?>" data-tooltip="tooltip" data-placement="top" title="<?php echo Yii::t('app', 'Images') ?>">
        ...
        <button disabled class="btn btn-link" data-tooltip="tooltip" data-placement="top" title="<?php echo Yii::t('app', $modelName.' Report') ?>"><i class="fas fa-chart-bar"></i></button>
        <button disabled class="btn btn-link" data-tooltip="tooltip" data-placement="top" title="<?php echo Yii::t('app', 'Send Documents') ?>"><i class="fas fa-envelope"></i></button>
