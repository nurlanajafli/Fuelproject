...
<?= $form->field($model, 'vendor_id', ['options' => ['tag' => false]])->hiddenInput()->label(false); ?>
    <div class="col-6">
        <?= $form->field($model, 'contact_name')->textInput(); ?>
        <?= $form->field($model, 'department_id')->dropDownList(ArrayHelper::map(Department::find()->all(), 'id', '_label'), ['prompt' => 'Select']); ?>
