...
(function (e) {
    ...
    e.fn.dataTableExt.oApi.fnColReorder = function (a, b, c, f, h) {
        ...
        if (b != c) if (0 > b || b >= k) this.oApi._fnLog(a, 1, "ColReorder 'from' index is out of bounds: " + b); else if (0 > c || c >= k) this.oApi._fnLog(a, 1, "ColReorder 'to' index is out of bounds: " +
            ...
            if (a.aoColumns[b].bVisible) {
                ...
                if (null !== a.nTFoot) for (l = a.nTFoot.getElementsByTagName("tr"), d = 0, g = l.length; d < g; d++) A(l[d], p, m);
                d = 0;
            ...
            for (g = a.aoData.length; d < g; d++) {
                m = a.aoData[d];
                if (n = m.anCells) for (v(n, b, c), l = 0, p = n.length; l < p; l++) n[l] && n[l]._DT_CellIndex && (n[l]._DT_CellIndex.column = l);
    ...
    e.extend(r.prototype, {
        ...
        fnOrder: function (a, b) {
            ...
            if (h) if (a.s.dt._bInitComplete) b = y(h), a._fnOrderColumns.call(a,
                b); else {
                var g = !1;
        ...
        _fnStateSave: function (a) {
            ...
            b !== z && (this.s.mouse.startX = this._fnCursorPosition(a, "pageX"), this.s.mouse.startY = this._fnCursorPosition(a,
                "pageY"), this.s.mouse.offsetX = this._fnCursorPosition(a, "pageX") - f.left, this.s.mouse.offsetY = this._fnCursorPosition(a, "pageY") - f.top, this.s.mouse.target = this.s.dt.aoColumns[b].nTh, this.s.mouse.targetIndex = b, this.s.mouse.fromIndex = b, this._fnRegions(), e(t).on("mousemove.ColReorder touchmove.ColReorder", function (h) {
            ...
            var a = "" !== this.s.dt.oScroll.sX ||
                ...
                f = c.parentNode, h = f.parentNode, g = e(b).clone();
            ...
            this.dom.pointer = e("<div></div>").addClass("DTCR_pointer").css({
                position: "absolute",
                top: a ? e("div.dataTables_scroll", this.s.dt.nTableWrapper).offset().top :
    ...
    e.fn.dataTable.Api.register("colReorder.enable()",
        function (a) {
