...
(function (h) {
    ...
    function F(a) {
        var b = h(a.table().container()), c = a.settings()[0], d = c._select.selector, e;
    ...
    function I(a) {
        ...
        if (b._select.info &&
            ...
            var c = a.rows({selected: !0}).flatten().length, d = a.columns({selected: !0}).flatten().length,
                e = a.cells({selected: !0}).flatten().length, g = function (f, k, l) {
    ...
    function K(a, b) {
        return -1 !== h.inArray("rows", b.limitTo) && a.rows({selected: !0}).any() || -1 !== h.inArray("columns", b.limitTo) && a.columns({selected: !0}).any() || -1 !== h.inArray("cells", b.limitTo) && a.cells({selected: !0}).any() ? !0 : !1
    }
    ...
    m.select.init = function (a) {
        var b = a.settings()[0], c = b.oInit.select, d = m.defaults.select;
        c = c === n ? d : c;
        d = "row";
        var e = "api", g = !1,
            f = !0, k = !0, l = "td, th", p = "selected", u = !1;
        b._select = {};
        ...
        h.fn.dataTable.ext.order["select-checkbox"] =
            function (z, L) {
                return this.api().column(L, {order: "index"}).nodes().map(function (H) {
    ...
    var v = m.Api.register, w = m.Api.registerPlural;
    v("select()", function () {
    ...
    h.extend(m.ext.buttons, {
        selected: {
            ...
            text: y("selectedSingle",
                "Selected single"), className: "buttons-selected-single", init: function (a, b, c) {
                var d = this;
                c._eventNamespace = ".select" + D++;
                a.on(C(c), function () {
            ...
            text: y("selectAll", "Select all"), className: "buttons-select-all", action: function () {
                this[this.select.items() + "s"]().select()
            }
        }, selectNone: {
            text: y("selectNone",
                "Deselect all"), className: "buttons-select-none", action: function () {
                x(this.settings()[0], !0)
            }, init: function (a, b, c) {
                var d = this;
                c._eventNamespace = ".select" + D++;
    ...
    h.each(["Row", "Column", "Cell"], function (a, b) {
        ...
        m.ext.buttons["select" + b + "s"] = {
            text: y("select" +
                b + "s", "Select " + c + "s"), className: "buttons-select-" + c + "s", action: function () {
                this.select.items(c)
            }, init: function (d) {
                var e = this;
