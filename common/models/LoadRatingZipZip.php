...
use common\models\base\LoadRatingZipZip as BaseLoadRatingZipZip;
use Yii;

/**
 * This is the model class for table "load_rating_zipzip".
 */
class LoadRatingZipZip extends BaseLoadRatingZipZip implements LoadRatingMethodInterface
{
    ...
    {
        $first = ['zip_1_start', 'zip_1_end', 'zip_2_start', 'zip_2_end'];
        $last = ['description'];
