...
/**
 * This is the base-model class for table "vendor_contact".
 *
 * @property integer $id
 ...
 */
abstract class VendorContact extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['vendor_id'], 'required'],
            [['vendor_id', 'department_id'], 'default', 'value' => null],
            [['vendor_id', 'department_id'], 'integer'],
            [['notes'], 'string'],
